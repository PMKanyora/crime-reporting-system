      ...
      <div class="header-right">
        <div class="profile_details_left"><!--notifications of menu start -->
          <ul class="nofitications-dropdown">
            <?php
$ret1=mysqli_query($con,"select ID,Name from  tblreports where Status=''");
...
{
            ?>
                 <a class="dropdown-item" href="view-reportedcrime.php?viewid=<?php echo $result['ID'];?>">New crime reprted from <?php echo $result['Name'];?> </a><br />
<?php }} else {?>
    <a class="dropdown-item" href="all-reportedcrime.php">No New Crimes reported</a>
        <?php } ?>
                 ...
                 <li>
                  <div class="notification_bottom">
                    <a href="new-reportedcrime.php">See all notifications</a>
                  </div> 
                </li>
              </ul>
            </li> 
