...
if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($con, "update  tblreports set Remark='$remark',Status='$status' where ID='$cid'");
    if ($query) {
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">View Crimes</h3>
    ...
    echo $msg;
						...
						<?php
$cid=$_GET['viewid'];
$ret=mysqli_query($con,"select * from tblreports where ID='$cid'");
$cnt=1;
