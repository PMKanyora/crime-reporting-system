...
?>
					...
					<div class="col-md-4 widget states-mdl">
						<?php $query2=mysqli_query($con,"Select * from tblreports");
$totalcrimes=mysqli_num_rows($query2);
?>
						<div id="stats-left">
							<h5>Total</h5>
						...
						<div id="stats-right">
							<label> <?php echo $totalcrimes;?></label>
						</div>
						<div class="clearfix"> </div>	
					</div>
					<div class="col-md-4 widget states-last">
						<?php $query3=mysqli_query($con,"Select * from tblreports where Status='1'");
$totalaccapt=mysqli_num_rows($query3);
?>
						<div id="stats-left">
							<h5>Total</h5>
							<h4>Approved Crimes</h4>
						</div>
						<div id="stats-right">
				...
				<div class="row calender widget-shadow">
					<div class="row-one">
					<div class="col-md-4 widget">
						<?php $query4=mysqli_query($con,"Select * from tblreports where Status='1'");
$totalreject=mysqli_num_rows($query4);
?>
						<div id="stats-left ">
							<h5>Total</h5>
							<h4>Rejected Crimes</h4>
						</div>
						<div id="stats-right">
							<label> <?php echo $totalreject;?></label>
						</div>
						<div class="clearfix"> </div>	
					</div>
					<div class="col-md-4 widget states-mdl">
						<?php $query5=mysqli_query($con,"Select * from  tblcrimes");
$totalcr=mysqli_num_rows($query5);
?>
						<div id="stats-left">
							<h5>Total</h5>
							<h4>Crime types</h4>
